...
/* 수정 내용
* 1. 헤더 파일 수정 : io.h 헤더파일 제거, unistd.h 헤더파일 추가
* 2. O_BINART 무시하도록 수정 : 30 - 36 라인
* 3. 형식 지정자 수정
*  1) 133 라인 1번째 형식지정자 : %lu -> %u
*  2) 162 라인 1번째 형식지정자 : %d -> %ld
*/
...
/*
* 유닉스 계열에서는 Binary 파일과 Text 파일을 동일하게 다루기 때문에 O_BINARY 플래그가 정의되어
* 있지 않음. 따라서, 해당 플래그를 무시하도록 설정함
*/
#ifndef O_BINARY
  #define O_BINARY 0
#endif
